...
var HttpRequestService = /** @class */ (function () {
    ...
    HttpRequestService.prototype.postRequestWithCredentials = function (url, credentials, body) {
        this.completeUrl = "http://localhost:3000/modifyUser?id=" + credentials.id + "&token=" + credentials.token;
        if (url != undefined)
            this.completeUrl = "http://localhost:3000/" + url + "?id=" + credentials.id + "&token=" + credentials.token;
